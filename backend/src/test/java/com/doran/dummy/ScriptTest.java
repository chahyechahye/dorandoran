...
public class ScriptTest {
    ...
    public void test() {
        ...
        for (String s : script) {
            ...
            recordBook.setScriptNum(scriptNum++);
            recordBook.setScript(s);
            recordBook.setTitle(title);
    ...
    public String[] script() {
        String text = "\"옛날 옛적에 소망을 이루어 주는 힘이 여전히 통했던 때에, 딸들이 모두 예쁜 왕이 한 분 살고 계셨어요.\"\n"
            ...
            + "\"“공주님! 막내공주님! 제게 문을 열어주시어요! 어제 시원한 분수대 옆 물가에서 제게 하신 말씀을 그새 잊으신 건 아니겠죠? 공주님, 막내공주님! 어서 문을 열어주시어요!” \"\n"
            + "그러자 왕이 말씀하셨어요.\n"
            ...
            + "하지만 그건 자신의 주인(=왕자님)이 마법에서 풀려나 행복한 것이 너무도 기뻤던 충직한 종인 ‘헨리’(남자이름. 왕자님의 종)의 심장이 용솟음치면서 쇠테(철로 만든 띠)를 망치처럼 두드리는 바람에 내는 소리였답니다.\n";
